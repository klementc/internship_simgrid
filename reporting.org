...
- CloudSim's code. There is HostDynamicWorkload which might correspond to
  elastic taks. List of processing elements,
- Took a look at [[IS_p][ISim's paper]] but because it was speaking of dynamic
  workload. But it is a meta-scheduler and it performs workload consolidation
  for power management. In the end I think it has nothing to do with what I
  looking for.
...
- [ ] See concurrent tools like DCsim and GridSim. Pay attention to varying
