...
** Bibliography
   *Background*
     ...
     As the works are on reacting to variating usage, simulators need a way to
     express this fluctuating workload. We worked on elastic tasks that model
   ...
   *State of the art* (Needs for elastic tasks and concurrent tools)
     ...
     // Tell that simgrid doesn't all last 3 ?
