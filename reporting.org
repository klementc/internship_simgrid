...
* Introduction
  ...
  for example. [[SG_p][SimGrid]] is one of them and the one I have worked on during my
...
* Findings
** Bibliography
- <<SG_p>>[[http://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=1199362][SimGrid]].
- <<CS_p>>[[http://www.buyya.com/papers/CloudSim2010.pdf][CloudSim]], [[https://github.com/Cloudslab/cloudsim][repo]].
...
- [[http://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=6779436&tag=1][Survey]].
- [[http://ieeexplore.ieee.org/ielx7/7092813/7092808/07092927.pdf?tp=&arnumber=7092927&isnumber=7092808][Complement to simulations]].
** Contribution
...
- Wrote some sort of scenario file for proposal 1 and 2. Needs more work to have
  ...
  one.
- Criterion of quality for proposals.
...
*** Blocking Points
*** Planned Work
- [ ] More detailed entries for papers read. Abstract (1 sentence, objectives),
...
- [ ] Put the papers descriptions in the bibliography section (write it like a
      related work section).
- [ ] Write a scenario file (needs description). Put it in the contribution
      section.
- [ ] Search for potential users through workbench citations.
