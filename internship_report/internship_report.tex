...
%TODO 2 part in experiment, the static (platform) and dynamic (workload) (?)
%\author{
	  ...
	  \begin{figure}
	  	...
	  	\begin{center}
	  		\begin{tabular}{| l | c | c |}
	  			...
	  			Workflow & YES & \\
	  			\hline
	  			Threshold & NO & \\  %TODO define threshold, in contribution 
	  			                     %     section(?)
          \hline \hline
...
%TODO put detailed before, in contrib (?)
